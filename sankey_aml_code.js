...
(function() {
    ...
    function fundsTrackerService($resource, resources, messageService, amlConfig, amlConstants, linksProcessor,
                                 exceptionResourceHandler, $window, kendoGridRendererService) {
        var transactionsCSVUri = '/transactions.csv';
        // define resources
